...
export declare const asOdds: (n: number) => DecimalOdds;
export declare const asRaw: (n: number) => RawProbability;
export declare const asFair: (n: number) => FairProbability;
export declare const asConsensus: (n: number) => ConsensusProbability;
export declare const asAdjusted: (n: number) => AdjustedProbability;
/**
